...
const BusinessLaptops = () => {
  ...
  const filteredProducts = products.filter((product) => {
    ...
    const matchesCategory = product.category === 'Business';
  ...
  return (
    <div className={`min-h-screen pb-16 ${isDarkMode ? 'bg-gray-900 text-gray-100' : 'bg-gray-50 text-gray-800'} relative overflow-hidden`}>
      ...
      <section className="relative overflow-hidden">
        <div className="relative bg-gradient-to-r from-blue-900 via-indigo-800 to-blue-900 py-24 px-4">
          {/* Hero background decorations */}
          <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
            <div className="absolute -top-32 -left-32 w-96 h-96 bg-blue-400 rounded-full filter blur-3xl opacity-30"></div>
            <div className="absolute top-1/3 -right-32 w-96 h-96 bg-indigo-400 rounded-full filter blur-3xl opacity-30"></div>
            <div className="absolute bottom-0 left-1/4 w-64 h-64 bg-blue-300 rounded-full filter blur-3xl opacity-20"></div>
          ...
          <div className="max-w-7xl mx-auto relative">
            <div className="md:flex md:items-center md:justify-between">
              <div className="text-center md:text-left md:w-1/2">
                <div className="inline-flex items-center px-4 py-1 rounded-full bg-blue-700/80 text-blue-100 text-sm font-medium mb-6 shadow-lg backdrop-blur-sm">
                  <BriefcaseIcon className="h-4 w-4 mr-2" />
                  Professional Performance
                </div>
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-white leading-tight">
                  Business <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-indigo-300">Laptops</span>
                </h1>
                <p className="text-lg mb-8 text-blue-100 max-w-xl mx-auto md:mx-0">
                  Powerful, reliable, and secure laptops designed for professionals. Perfect for demanding workloads, virtual meetings, and business on the go.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                  <Link
                    to="/catalog"
                    className="bg-transparent border-2 border-blue-300 text-white px-8 py-3 rounded-lg font-medium hover:bg-blue-800/50 hover:border-blue-200 transition duration-300 flex items-center justify-center backdrop-blur-sm"
                  >
                  ...
                  <Link
                    to="catalog"
                    className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-8 py-3 rounded-lg font-medium transition duration-300 flex items-center justify-center shadow-lg"
                  >
              ...
              <div className="hidden md:block md:w-2/5">
                <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 shadow-xl mt-8 md:mt-0 border border-white/20">
                  <h3 className="text-xl font-semibold text-white mb-4">Built for Business</h3>
                  <ul className="space-y-3">
                    {['Enhanced security features', 'All-day battery life', 'Powerful performance', 'Durable build quality'].map((feature, index) => (
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className={`p-6 rounded-xl shadow-lg mb-8 relative overflow-hidden ${isDarkMode ? 'bg-gray-800/80 backdrop-blur-md' : 'bg-white/80 backdrop-blur-md'} border ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}>
            ...
            <div className="relative mb-6">
              ...
              <input
                type="text"
                placeholder="Search business laptops..."
          ...
          <div className="flex justify-between items-center mb-8">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl font-bold">{isLoading ? "Loading..." : `${sortedProducts.length} Business Laptops`}</h2>
            </div>
            ...
            {isLoading ? (
              ...
              <div className={`col-span-full p-10 text-center rounded-xl ${isDarkMode ? 'bg-gray-800/90 backdrop-blur-sm' : 'bg-white/90 backdrop-blur-sm'} shadow-md border ${isDarkMode ? 'border-gray-700/50' : 'border-gray-200/50'}`}>
                <div className="flex flex-col items-center">
                  ...
                  <h3 className="text-xl font-medium mb-2">No business laptops found</h3>
